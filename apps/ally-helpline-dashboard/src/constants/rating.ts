 ...
 * that colour resolved to white/transparent (it churned through #faf9f5 /
 * #e3dbce), which is why the stars only showed up "sometimes".
 */

// Legacy — kept for the standalone StarYellowIcon asset (@assets) and its test.
export const STAR_COLOR_FILLED = "#F9CC49"; // gold
export const STAR_COLOR_EMPTY = "#928b7c"; // Carbon gray-50
...
export const STAR_PALETTE = {
  ...
  empty: { fill: "#eae7de", stroke: "#bcb4a4" }, // always-visible grey outline
} as const;
