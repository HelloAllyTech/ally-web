...
export const carbonField = {
  ...
  input:
    "w-full h-10 bg-[#f0eee7] text-[#29261f] font-primary text-sm px-4 rounded-none border-0 border-b border-[#928b7c] outline-none transition-colors placeholder:text-[#928b7c] focus:border-b-2 focus:border-[#264d8e] disabled:text-[#bcb4a4] disabled:cursor-not-allowed",
  textarea:
    "w-full bg-[#f0eee7] text-[#29261f] font-primary text-sm p-4 rounded-none border-0 border-b border-[#928b7c] outline-none transition-colors placeholder:text-[#928b7c] focus:border-b-2 focus:border-[#264d8e] disabled:text-[#bcb4a4] resize-y min-h-[6rem]",
  select:
    "w-full h-10 bg-[#f0eee7] text-[#29261f] font-primary text-sm pl-4 pr-9 rounded-none border-0 border-b border-[#928b7c] outline-none focus:border-b-2 focus:border-[#264d8e] disabled:text-[#bcb4a4] disabled:cursor-not-allowed appearance-none",
  selectChevron:
