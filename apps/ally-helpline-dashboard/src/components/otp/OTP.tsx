    ...
    <div className={cn("flex gap-6 items-center", className)} {...props}>
      {Array.from({ length: digitCount }, (_, index) => (
        <Input
          ...
          className={cn(
            "w-[64px] h-[64px] bg-[#F5F5F5] rounded-[12px] text-center text-[20px] font-medium placeholder:text-typography-800 placeholder:font-normal placeholder:text-3xl border-0 focus-visible:ring-0",
            inputClassName,
          )}
        />
      ))}
