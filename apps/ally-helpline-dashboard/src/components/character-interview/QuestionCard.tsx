 ...
 * ally-admin-dashboard's Character Library / Roleplay Studio copilot
 * QuestionCard). Single-select and free-text answer inline; multi-select and
 * dropdown collect a set then Confirm. "None of these" and an "add your own"
 * entry are offered when the question allows them. Once answered the card
 * locks (also on resume).
 */
