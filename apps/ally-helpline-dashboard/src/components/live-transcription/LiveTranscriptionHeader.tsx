...
const LiveTranscriptionHeader = ({ name, status, rightContent }: LiveTranscriptionHeaderProps) => {
  return (
    <div className="flex items-center justify-between border-b p-4 bg-gray-800">
      <div className="flex items-center gap-2">
        <Circle
          className={cn(
            "h-2 w-2",
            status === "online" ? "fill-green-500 text-green-500" : "fill-gray-400 text-gray-400",
          )}
        />
