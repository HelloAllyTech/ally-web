// File: apps/ally-helpline-dashboard/src/pages/health-check/Health.tsx
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
        ...
        <div className="flex items-center justify-center space-x-3 my-6">
          ...
          <p className="text-4xl font-extrabold text-green-500">{t("health.status.healthy")}</p>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
          ...
          <p className="text-xs text-typography-600 dark:text-typography-700 mt-2">
            {t("health.lastChecked", { time: lastChecked.toLocaleTimeString() })}
          </p>
        </div>
      </div>
    </div>
