      ...
      <div className="w-[55vw] h-full flex flex-col">
        ...
        {selectedTab === 1 && (
          <div className="w-full h-full p-2">
            <div className="w-full p-[10px] mb-4 flex items-center gap-2 border-[0.5px] border-[#EC930F] rounded-[8px] bg-[#FDF8E4]">
              <Warning className="w-8 h-8 p-2 border-[0.5px] border-[#EC930F] rounded-[100px]" />
              <span className="text-[12px] text-[#873200] font-['Roboto'] font-medium">
                This summary has been generated by AI. Ally AI can make mistakes. Review and edit
                important info before saving the summary.
              </span>
            </div>
