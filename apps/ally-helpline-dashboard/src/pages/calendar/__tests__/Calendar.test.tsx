/**
 * Comprehensive Unit Tests for Calendar Component
 *
 * Test Coverage:
...
describe("Calendar Component", () => {
  ...
  describe("Basic Rendering", () => {
    it("should render the Calendar component successfully", () => {
   ...
   * Verifies that props are not passed to Calendar (it's a presentational component)
   */
  describe("Component Props", () => {
    it("should render consistently without any props", () => {
      const { container: container1 } = render(<Calendar />);
  ...
  describe("Edge Cases", () => {
    it("should render consistently on multiple renders", () => {
      const { container: firstRender } = render(<Calendar />);
      const { container: secondRender } = render(<Calendar />);
  ...
  describe("Component Integration", () => {
    ...
    it("should not pass className prop to FallbackUI", () => {
      // This test verifies that Calendar doesn't add custom className
