  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center gap-3 w-full px-4 py-2 text-left text-text-700 hover:bg-background-secondary transition-colors"
      >
        <div className="w-4 h-4 text-text-500">
          <Trash />
        </div>
