...
export const SimulationList: React.FC<SimulationListProps> = ({
    ...
    return (
      ...
      >
        ...
        <div
          ...
          className="w-[18%] md:w-[10%] lg:w-[7%] h-[56px] cursor-pointer rounded-lg overflow-hidden flex-shrink-0 bg-neutral-100"
        >
          <CustomImage
        ...
        >
          <h3 className="text-sm text-typography-900">{simulation.title}</h3>
          <div className="text-typography-800 leading-relaxed line-clamp-2">
  ...
  return (
    <div className="flex flex-col w-full overflow-x-auto font-primary overflow-y-scroll h-[calc(100vh-140px)]">
      {tableHeader}
