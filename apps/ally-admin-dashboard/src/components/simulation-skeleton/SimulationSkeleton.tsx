...
export const SimulationSkeleton: React.FC = () => {
  return (
    <div className="animate-pulse">
      <div className="flex flex-row items-center justify-between w-[100%] border-b border-gray-200 px-4 py-3">
...
export const SimulationListSkeleton: React.FC = () => {
  const renderTableHeaderSkeleton = () => {
    return (
      <div className="animate-pulse">
        <div className="flex flex-row items-center justify-between w-[100%] border-b border-gray-200 px-4 py-2">
          <div className="w-[45%]">
            <div className="h-4 bg-gray-200 rounded w-20"></div>
          </div>
          <div className="w-[12%] px-4">
