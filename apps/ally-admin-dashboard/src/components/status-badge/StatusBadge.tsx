...
export const StatusBadge: React.FC<{ status: userStatus | string }> = ({ status }) => {
  const STATUS_STYLES: Record<string, { dot: string; bg: string; text: string }> = {
    ACTIVE: { dot: "bg-success-400", bg: "bg-success-100", text: "text-text-600" },
    SUSPENDED: { dot: "bg-destructive-400", bg: "bg-destructive-50", text: "text-text-600" },
    INACTIVE: { dot: "bg-neutral-400", bg: "bg-neutral-100", text: "text-text-600" },
    BLOCKED: { dot: "bg-destructive-500", bg: "bg-destructive-100", text: "text-text-600" },
  };
