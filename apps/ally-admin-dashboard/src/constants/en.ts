export const en = {
  ...
  errors: {
    ...
    failedPathwayChange: "Failed to save trackway changes!",
  ...
  simulation: {
    duplicatePathwayDescription:
      "Are you sure you want to duplicate this trackway? This will create a new trackway with the same configurations.",
    ...
    pathwayDuplicatedSuccessfully: "trackway duplicated successfully",
    simulationDuplicatedSuccessfully: "Simulation duplicated successfully",
    failedDuplicatePathway: "Failed to duplicate trackway",
    ...
    failedChangePathwayStatus: "Failed to change trackway status",
    pathwayStatusUpdatedSuccessfully: "Trackway status updated to ",
    pathwayDeletedSuccessfully: "Trackway deleted successfully",
    failedDeletePathway: "Failed to delete trackway",
    deletePathway: "Delete trackway",
    deletePathwayDescription:
      "I understand that deleting this simulation trackway is permanent and that I will lose all access to users and simulation trackway analytics.",
    pathway: "Trackway",
    paths: "Tracks",
    createPathway: "Create trackway",
    ...
    newTrackway: "New track way",
    createYourFirst: "Create your first",
    createYourFirstPathway: "Create your first trackway",
    ...
    editPathwayDescription:
      "Are you sure you want to edit this trackway? This will be moved to draft state.",
