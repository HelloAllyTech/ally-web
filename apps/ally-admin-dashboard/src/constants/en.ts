export const en = {
  ...
  roleplayStudio: {
    ...
    copilot: {
      ...
      improvement: {
        ...
        running: "Auto-improving",
        runningHint:
          "Rehearsing with simulated trainees, then applying fixes — this can take a few minutes. You can leave and come back.",
      },
    },
    spec: {
      ...
      agentTestCases: "Agent test cases",
      agentTestCasesPlaceholder: "Search and select test cases",
      agentTestCasesCategory: "Category",
      agentTestCasesAllCategories: "All categories",
      agentTestCasesRecommended: "Recommended",
      agentTestCasesSelected: "{count} selected",
  ...
  aiLab: {
    ...
    runs: {
      heading: "Runs",
      comingSoon: "Runs are coming soon",
      comingSoonSubtitle:
        "This is where you'll execute skills with variable values substituted in. Nothing to see here yet.",
    },
    unsavedChangesWarning: "You have unsaved changes. Are you sure you want to close?",
