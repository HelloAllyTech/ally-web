export const en = {
  ...
  simulation: {
    ...
    agentBuilder: {
      ...
      // Claude-Coding-style chat UI
      send: "Send",
      revisePlaceholder:
        "Ask for changes to the roleplay settings — e.g. make the client more guarded, slower to open up, or change their backstory…",
      failedToRevise: "Failed to start the revision. Please try again.",
      buildSettings: "Build settings (skill version & model)",
      skillVersionLabel: "Agent skill version",
      modelLabel: "AI model for this task",
      composerHint: "Press ⌘/Ctrl + Enter to send.",
      emptyFeedHint:
        "Describe the person the AI should role-play below, and I'll build and test a roleplay agent for you.",
      startingBuild: "Starting agent build…",
      generatingFields: "Generating settings",
      viewDetails: "View details",
      viewLiveConversation: "View live conversation",
      detailPanelTitle: "Test conversation & evaluation",
      closePanel: "Close panel",
      detailTabEvaluation: "Evaluation",
      detailTabTranscript: "Transcript",
      metricsLabel: "Scores by metric",
      noEvaluationYet: "No evaluation available for this round yet.",
      noTranscriptYet: "No transcript available yet.",
      loadingTranscript: "Loading transcript…",
      loadMore: "Load more",
      reviewAndApply: "Review & apply in Basic Settings",
      applyReadyLabel: "Your agent is ready.",
      applyBestSoFarLabel: "Best result so far — review the draft and adjust as needed.",
    },
  },
  notification: {
