...
export const FORM_FIELD_IDS = {
  ...
  ENABLE_PERFORMATIVE_TEXT: "enablePerformativeText",
  ENABLE_BREAK_TAGS: "enableBreakTags",
...
export const SIMULATION_CREATOR_FIELD_GROUPS: CreatorFieldGroups[] = [
  {
    ...
    fields: [
      ...
      {
        id: "enablePerformativeText",
        label: "Performative Speech (non-v3 voices)",
        type: FORM_FIELD_TYPES.TOGGLE_BUTTON,
        fullWidth: true,
        defaultValue: false,
        note: "Adds punctuation/pacing/disfluency guidance so non-ElevenLabs-v3 voices read more expressively. No effect on v3 voices.",
      },
      {
        id: "enableBreakTags",
        label: "Break Tags (ElevenLabs)",
        type: FORM_FIELD_TYPES.TOGGLE_BUTTON,
        fullWidth: true,
        defaultValue: false,
        note: "Lets the agent insert <break/> pauses on ElevenLabs (non-v3) voices. Ignored on providers that don't parse break tags.",
      },
      {
        id: "temperature",
