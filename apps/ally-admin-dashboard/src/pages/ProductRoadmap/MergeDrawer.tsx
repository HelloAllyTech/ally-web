 ...
 */
export const MergeDrawer: React.FC<MergeDrawerProps> = ({ onClose, onMerged }) => {
  ...
  return (
    ...
    >
      <aside
        className="bg-white relative flex h-full w-[34rem] max-w-full flex-col overflow-y-auto"
        onClick={event => event.stopPropagation()}
      >
        <header className="border-border-light flex items-center justify-between border-b p-4">
          <h2 className="text-typography-primary text-lg">Merge opportunities</h2>
        ...
        <div className="flex flex-col gap-4 p-4">
          {/* Picked list first: it is the thing being built, and putting the search above it
              would push it further down the panel with every addition. */}
          {picked.length > 0 && (
