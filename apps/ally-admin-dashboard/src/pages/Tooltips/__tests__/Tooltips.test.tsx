...
describe("TooltipManagement", () => {
  ...
  describe("Initial rendering", () => {
    ...
    it("displays all tooltips in the table", async () => {
      renderComponent();
      await waitFor(() => {
  ...
  describe("Create tooltip", () => {
    ...
    it("calls createTooltip with correct data on save", async () => {
      renderComponent();
      fireEvent.click(screen.getByTestId("create-button"));
  ...
  describe("Edit tooltip", () => {
    it("opens side panel with correct data when row is clicked", async () => {
      renderComponent();
    ...
    it("calls updateTooltip with correct data on save", async () => {
      renderComponent();
      await waitFor(() => fireEvent.click(screen.getByTestId("table-row-1")));
  ...
  describe("Inline row change", () => {
    ...
    it("shows error toast and reverts optimistic update when inline change fails", async () => {
      mockUpdateTooltip.mockResolvedValue({ error: { status: 500 } });
      renderComponent();
      await waitFor(() => fireEvent.click(screen.getByTestId("toggle-active-0")));
      await waitFor(() =>
