...
export const moreOptions = ['Option 1', 'Option 2', 'Option 3', 'Option 4', 'Option 5', 'Option 6', 'Option 7', 'Option 8', 'Option 9', 'Option 10'];
...
export const resources = [
    ...
    },
    {
      ...
      description:
        'A comprehensive guide to mindfulness meditation techniques for stress reduction and mental clarity. Learn various meditation practices including breath awareness, body scanning, and loving-kindness meditation. The guide includes step-by-step instructions, audio recordings, and practical tips for maintaining a regular meditation practice. Perfect for beginners and experienced practitioners alike.',
      category: 'techniques',
    ...
    },
    {
      ...
      description:
        'A detailed FAQ addressing common questions and concerns about starting therapy. Topics include what to expect in your first session, how to choose the right therapist, understanding different therapy approaches, and managing therapy costs. This resource helps demystify the therapy process and provides practical guidance for those considering mental health support.',
      category: 'questions',
      tags: ['therapy', 'FAQ', 'mental health'],
    },
    {
      id: '9',
      title: 'The Garden of Growth',
      description:
        'A therapeutic metaphor comparing personal growth to tending a garden. This resource uses the metaphor of planting seeds, nurturing growth, and dealing with weeds to explain the process of personal development and healing. Includes interactive exercises and reflection prompts to help apply the metaphor to personal experiences.',
      category: 'metaphors',
      tags: ['growth', 'healing', 'personal development'],
    },
    {
      id: '10',
      title: 'Crisis Intervention Resources',
      description:
        'Immediate support and resources for mental health crises. Includes emergency contact information, crisis hotlines, and step-by-step guidance for various crisis situations. This resource provides clear, actionable information for both individuals in crisis and those supporting them.',
      category: 'resources',
    ...
    },
    {
      ...
      description:
        'A comprehensive guide explaining anxiety, its causes, and common symptoms. Learn about different types of anxiety disorders, their impact on daily life, and evidence-based coping strategies. The guide includes self-assessment tools and practical exercises for managing anxiety symptoms.',
      category: 'questions',
    ...
    },
    {
      ...
      description:
        'A powerful metaphor for the recovery journey, comparing it to climbing a mountain. This resource uses the metaphor of preparation, challenges, rest stops, and reaching summits to illustrate the process of healing and growth. Includes guided visualization exercises and journaling prompts.',
      category: 'metaphors',
      tags: ['recovery', 'journey', 'growth'],
    }
  ];
