...
export const RichTextRenderer: FC<RichTextRendererProps> = ({
  ...
  return (
    <div
      className={`rich-text-content prose prose-sm max-w-none text-typography-900 leading-relaxed [&_h1]:text-[1.25em] [&_h1]:font-bold [&_h1]:my-2 [&_h2]:text-[1.125em] [&_h2]:font-semibold [&_h2]:my-1.5 [&_h3]:text-[1em] [&_h3]:font-semibold [&_h3]:my-1 [&_p]:my-1 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:my-1 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:my-1 [&_li]:my-0.5 [&_blockquote]:border-l-4 [&_blockquote]:border-gray-300 [&_blockquote]:pl-4 [&_blockquote]:my-2 [&_blockquote]:text-typography-700 [&_blockquote]:italic [&_hr]:my-3 [&_hr]:border-gray-200 [&_img]:max-w-full [&_img]:h-auto [&_img]:rounded-md [&_img]:my-2 ${className}`}
